...
TextStyle _hintTextStyle =
    AppTextStyle.bodyRegular.copyWith(color: Color(0xffbdc1c6));
...
class _DropdownFieldState<T extends BaseObject>
    extends State<DropdownField<T>> {
                  ...
                  child: Container(
                    ...
                    child: DropdownButton<T>(
                      ...
                      onChanged: (T? value) {
                        ...
                        if (value.toDatabaseMap()[widget.controller.keyId] ==
                            -1) {
                          setState(() {
