...
class CreateCompanyViewModel extends BaseViewModel {
  ...
  FormFieldController adhaarNumberController = FormFieldController(
    ...
    inputFormatter: InputFormatter.vehicleFormatter,
    validator: (p1) {
  ...
  AmountFormFieldController amountController = AmountFormFieldController(ValueKey("amount"));
  ...
  FormFieldController gstNoController = FormFieldController(ValueKey("txtGstNo"),required: true, maxLength: 15, validator: (value) => InputValidator.gstNumberValidator(value));
